...
function CreateAccount() {
  return (
    <div className="CreateAccount">
        ...
        <br></br>
        <div class="apply-form-group-item half"><label for="ConfPass" class="apply-field-label-medium">Confirm Password* </label><input type="text" class="apply-text-field w-input" maxlength="256" name="Text" data-name="Text" id="Text" required=""/></div>
